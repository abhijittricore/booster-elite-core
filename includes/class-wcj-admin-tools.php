<?php
/**
 * Booster Core for WooCommerce - Module - Admin Tools
 *
 * @version 1.0.0
 * @author  Pluggabl LLC.
 */
...
class WCJ_Admin_Tools extends WCJ_Module {
	...
	function __construct() {
		...
		$this->desc       = __( 'Booster Core for WooCommerce general back-end tools. Enable interface by user roles (Plus). Custom shop manager editable roles (Plus).', 'woocommerce-jetpack' );
		$this->desc_pro   = __( 'Booster Core for WooCommerce general back-end tools.', 'woocommerce-jetpack' );
