<?php
/**
 * Booster Core for WooCommerce - Settings
 *
 * @version 1.0.0
 * @since   1.0.0
 * @author  Pluggabl LLC.
...
<?php
        ...
        public function create_free_version_footer_review_notice()
    {
            ...
            $message = sprintf(__('Please rate <strong>Booster Core for WooCommerce</strong> %s on <a href="%s" target="_blank">WordPress.org</a> to help us spread the word. Thank you from Booster team!', 'woocommerce-jetpack'), $stars_link, $link);
            ?>
<style>
.wcj-review-icon {
    vertical-align: middle;
...
<?php
    echo '<div class="' . $class . '"><p>' . $message . '</p></div>';
        ...
        ?>
            <div class="circleBox">
                ...
                <div class="subCircles">
                    ...
                    <div class="sub-circle">
                        ...
                        <div class="form_label">
                            <label>Booster VIP Support( 12 hours)</label>
            ...
            <?php
            if ('booster-core-for-woocommerce.php' !== basename(WCJ_PLUGIN_FILE)) {
                return;
            }
            $class = 'notice notice-info inline';
            $link = 'https://wordpress.org/support/plugin/woocommerce-jetpack/reviews/?filter=5#new-post';
...
<p style="color:gray;font-size:x-small;font-style:italic;"><?php echo __('Total Modules:') . ' ' . $total_modules; ?>
    ...
    public function get_settings($current_section = '')
    {
        if (!$this->is_dashboard_section($current_section)) {
            ...
            $settings[] = array(
                'title' => __('Booster Core for WooCommerce', 'woocommerce-jetpack') . ' - ' . $this->cats[$cat_id]['label'],
                'type' => 'title',
