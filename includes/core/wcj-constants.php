<?php
/**
 * Booster Core for WooCommerce Constants
 *
 * @version 1.0.0
 * @since  1.0.0
 * @author  Pluggabl LLC.
...
if ( ! defined( 'WCJ_VERSION_OPTION' ) ) {
	 ...
	 */
	define( 'WCJ_VERSION_OPTION', ( 'woocommerce-jetpack.php' === basename( WCJ_PLUGIN_FILE ) ? 'booster_for_woocommerce_version' : 'booster_core_for_woocommerce_version' ) );
}