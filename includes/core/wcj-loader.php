...
/**
 * Booster Core for WooCommerce - Core - Loader
 *
 * @version 1.0.2
 * @since  1.0.0
 * @author  Pluggabl LLC.
...
require_once(WCJ_PLUGIN_PATH . '/includes/class-wcj-product-variation-swatches-term-meta.php');

// Mini Plugin
require_once(WCJ_PLUGIN_PATH . '/includes/mini-plugin/wcj-mini-plugin.php');

// Plus
// if ('booster-core-for-woocommerce.php' === basename(WCJ_PLUGIN_FILE) && apply_filters('wcj_full_pack', true)) {
// 	require_once(WCJ_PLUGIN_PATH . '/includes/plus/class-wcj-plus.php');
// }

if ('booster-core-for-woocommerce.php' === basename(WCJ_PLUGIN_FILE) && apply_filters('wcj_full_pack', false)) {
	//require_once( WCJ_PLUGIN_PATH . '/includes/plus/class-wcj-plus.php' );
	require_once(WCJ_PLUGIN_PATH . '/includes/plus/class-wcj-plus-filters.php');
}
require_once(WCJ_PLUGIN_PATH . '/includes/plus/class-wcj-plus-functions.php');
require_once(WCJ_PLUGIN_PATH . '/includes/plus/class-wcj-plus-site-key-section.php');
require_once(WCJ_PLUGIN_PATH . '/includes/plus/class-wcj-plus-site-key-manager.php');
