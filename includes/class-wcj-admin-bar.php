...
/**
 * Booster Core for WooCommerce - Module - Admin Bar
 *
 * @version 1.0.1
 * @since  1.0.0
 * @author  Pluggabl LLC.
		...
		function get_nodes_booster_tools()
		{
			...
			$tools = apply_filters('wcj_tools_tabs', array(
				array(
					...
					'desc'  => __('This dashboard lets you check statuses and short descriptions of all available Booster Core for WooCommerce tools. Tools can be enabled through WooCommerce > Settings > Booster.', 'woocommerce-jetpack'),
				),
			));
