<?php
/**
 * Booster Core for WooCommerce - Plus - Site Key Section
 *
 * @version 1.0.0
 * @since  1.0.0
 * @author  Pluggabl LLC.
...
class WCJ_Plus_Site_Key_Section {
	...
	function add_site_key_section( $custom_dashboard_modules ) {
		$custom_dashboard_modules['site_key'] = array(
			'title'    => __( 'Site Key', 'woocommerce-jetpack' ),
			'desc'     => __( 'This section lets you manage site key for paid Booster Core for WooCommerce plugin.', 'woocommerce-jetpack' ) . ' ' .
