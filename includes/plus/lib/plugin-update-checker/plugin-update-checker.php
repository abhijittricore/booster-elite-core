...
if (!class_exists('PluginUpdateChecker_3_1', false)) :
	...
	class PluginUpdateChecker_3_1
	{
		 ...
		 */
		public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 24, $optionName = '', $muPluginFile = '')
		{
	...
	class PucScheduler_3_1
	{
		...
		public function __construct($updateChecker, $checkPeriod)
		{
			...
			if ($this->checkPeriod > 0) {
				...
				// Cron reset twice daily to daily once 
				if (wp_get_schedule($this->cronHook) === 'twicedaily') {
...
if (!class_exists('PucFactory', false)) :
	...
	class PucFactory
	{
		 ...
		 */
		public static function buildUpdateChecker($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 24, $optionName = '', $muPluginFile = '')
		{
