<?php
/**
 * Booster Core for WooCommerce - Module - Checkout Files Upload
 *
 * @version 1.0.0
 * @since  1.0.0
 * @author  Pluggabl LLC.
...
class WCJ_Checkout_Files_Upload extends WCJ_Module {
	...
	function process_checkout_files_upload() {
		...
		$admin_email_subject     = __( 'Booster Core for WooCommerce: Checkout Files Upload: %action%', 'woocommerce-jetpack' );
