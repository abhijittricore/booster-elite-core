<?php
/**
 * Booster Core for WooCommerce - Custom Payment Gateway
 *
 * @version 1.0.0
 * @author  Pluggabl LLC.
 */
		...
		if ( class_exists( 'WC_Payment_Gateway' ) ) {
			...
			class WC_Gateway_WCJ_Custom_Template extends WC_Payment_Gateway {
				...
				function init( $id_count ) {
					...
					$this->method_description       = __( 'Booster Core for WooCommerce: Custom Payment Gateway', 'woocommerce-jetpack' ) . ' #' . $id_count;
